...
<h1>ЗАДАНИЯ:</h1>
<h3>(ДЛЯ ВЛАДА) РЕАЛИЗАЦИЯ КОНТРОЛЛЕРА ПУБЛИЧНЫХ АПИ:</h3>
...
По логину\паролю от почты получить определенное письмо извлечь имя пользователя и найти 5-ти символьный пароль.
